...
So whatever deck you pick you have a 70% chance of losing providing the grifter has memorised the winning counter-deck. What an unfortunate state of affairs.
...
I also completed the riddler express which involves a maze. Obviously look away if you don't want it spoiled, but the key is to work backwards and see there's 1 clear fastest path. You can complete the maze in 24 moves.

```{r maze_answer, warning=FALSE,message=FALSE,echo=FALSE}
knitr::include_graphics("C:/Users/robwh/Desktop/static/img/riddler_maze.png")
```
