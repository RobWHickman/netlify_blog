...
\CommentTok{# we want to re list with }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# add in intercept term}
\NormalTok{relist_params <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(parameters) \{}
\NormalTok{  parameter_list <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}
    \DataTypeTok{alpha =}\NormalTok{ parameters }\OperatorTok{%>%}
\StringTok{      }\NormalTok{.[}\KeywordTok{grepl}\NormalTok{(}\StringTok{"alpha"}\NormalTok{, }\KeywordTok{names}\NormalTok{(.))] }\OperatorTok{%>%}
...
\StringTok{      `}\DataTypeTok{names<-}\StringTok{`}\NormalTok{(teams),}
    \DataTypeTok{gamma =}\NormalTok{ parameters[}\StringTok{"gamma"}\NormalTok{],}
    \DataTypeTok{phi =}\NormalTok{ parameters[}\StringTok{"phi"}\NormalTok{]}
\NormalTok{  )}
  \KeywordTok{return}\NormalTok{(parameter_list)}
\NormalTok{\}}

\CommentTok{# predict results with intercept added to exp argument}
\NormalTok{predict_results <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(home, away, param_list) \{}
\NormalTok{  e_goals_home <-}\StringTok{ }\KeywordTok{exp}\NormalTok{(param_list}\OperatorTok{$}\NormalTok{phi }\OperatorTok{+}\StringTok{ }\NormalTok{param_list}\OperatorTok{$}\NormalTok{alpha[home] }\OperatorTok{-}\StringTok{ }\NormalTok{param_list}\OperatorTok{$}\NormalTok{beta[away] }\OperatorTok{+}\StringTok{ }\NormalTok{param_list}\OperatorTok{$}\NormalTok{gamma)}
\NormalTok{  e_goals_away <-}\StringTok{ }\KeywordTok{exp}\NormalTok{(param_list}\OperatorTok{$}\NormalTok{phi }\OperatorTok{+}\StringTok{ }\NormalTok{param_list}\OperatorTok{$}\NormalTok{alpha[away] }\OperatorTok{-}\StringTok{ }\NormalTok{param_list}\OperatorTok{$}\NormalTok{beta[home])}
...
\CommentTok{# add intercept to the initial parameters}
\NormalTok{equal_parameters}\OperatorTok{$}\NormalTok{phi =}\StringTok{ }\DecValTok{0}

\CommentTok{# initialise i to collect data about theoptimisation process at each iteration}
...
\NormalTok{optimised_parameters5 <-}\StringTok{ }\KeywordTok{optim}\NormalTok{(}
  \DataTypeTok{par =} \KeywordTok{unlist}\NormalTok{(equal_parameters), }
  \DataTypeTok{fn =}\NormalTok{ optimise_params,}
  \DataTypeTok{results =}\NormalTok{ results,}
  \DataTypeTok{method =} \StringTok{"BFGS"}\NormalTok{,}
...
at 112- the same value for our initial calculation)
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p4 <-}\StringTok{ }\NormalTok{optimised_parameters5}\OperatorTok{$}\NormalTok{par }\OperatorTok{%>%}
...
\NormalTok{                      unplayed_games}\OperatorTok{$}\NormalTok{away, }
                      \KeywordTok{relist_params}\NormalTok{(optimised_parameters5}\OperatorTok{$}\NormalTok{par)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate_if}\NormalTok{(is.numeric, round, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
