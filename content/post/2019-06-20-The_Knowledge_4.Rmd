...
squads <- readRDS("C:/Users/robwh/Desktop/netlify_blog/static/files/premier_league_squads.rds")
```
...
elo_data <- readRDS("C:/Users/robwh/Desktop/netlify_blog/static/files/scraped_elo_data.rds")
...
x <- map_df(worst_national_team_players$url[1:10], get_international_matches) %>%
