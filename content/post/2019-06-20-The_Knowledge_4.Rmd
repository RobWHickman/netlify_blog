...
phantom_dir <- "C:/Users/rob-getty/Desktop/netlify_blog/static/files/phantomjs_scraping/"
...
split_teams <- function(t, o, c) {
  country <- gsub("_", " ", c)
  if(grepl(paste0("^", country), t)) {
    home = gsub(o, "", t)
    away = gsub(country, "", t)
  } else {
    home = gsub(country, "", t)
...
scrape_nation <- function(country) {
  ...
  system2("C:/Users/rob-getty/Downloads/phantomjs-2.1.1-windows/phantomjs-2.1.1-windows/bin/phantomjs.exe", 
          args = c(file.path(phantom_dir, "scrape_ELO.js"), url))
  
  country_name <- gsub("_", "", country)
  ...
  fixtures <- map2_df(teams, opposing, split_teams, c = country_name)
