...
I've been looking for small programming problems to practice on while running experiments. One such source is [Fivethirtyeight's Riddler](https://fivethirtyeight.com/features/how-fast-can-you-type-a-million-letters/) column which posts conundrums weekly. This week one problem focus on one of life's universal problems: how many urinals are needed in any bathroom for all patrons to use it without awkwardness.
...
#just going to use dplyr and purr
...
The formula is known as 'The Pay Phone Packing Sequence' (where users of pay phones don't want to be overheard) and is summarised at https://oeis.org/A185456 (where packing occurs/ n > 2). The formula itself is:

$$f(n) = n + 2 ^ {(1 + floor(log(n - 2)))}$$

That's all for this weeks riddler.

[Franz Ferdinand and Sparks - Piss Off](https://www.youtube.com/watch?v=l3V4KfeJBCQ)
