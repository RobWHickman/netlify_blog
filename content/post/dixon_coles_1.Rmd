...
teams <- c("Atletico Awesome", "Dinamo Decent", "Inter Ineffectual", "Torpedo Terrible") 
...
league_table <- melted_results %>%
  ...
  arrange(-season_points, -season_gd) %>%
  print()
...
goals_per_teams <- melted_results %>%
  group_by(team) %>%
