...
file <- "C:/Users/robwh/Downloads/Major_Towns_and_Cities_December_2015_Boundaries.geojson"
...
p_town_clubs <- ggplot() +
  ...
  geom_sf(data = club_locations, alpha = 0.5, colour = "blue") +
...
```{r smallest_town, warning=FALSE,message=FALSE}
#can also answer the inverse
town_data %>%
  filter(max_tier < 5) %>%
  arrange(pop)
```
